...
const directions = [
  {
    ...
    text: "Разрабатываем проектную и рабочую документацию с учётом требований нормативной базы, особенностей объекта и актуальных рисков. Предлагаем оптимальные инженерные решения, согласовываем и сопровождаем проект на всех этапах.",
    cta: "Обсудить проект",
    image: y1,
  ...
  },
  {
    ...
    text: "Выполняем комплексные расчёты и компьютерное моделирование процессов пожара с использованием современных методик и ПО. Результаты позволяют обосновывать проектные решения, снижать риски и обеспечивать соответствие требованиям нормативной базы.",
    ...
    works: [
      ...
      "Подбор и обоснование инженерных решений",
  ...
  },
  {
    ...
    tags: "Монтаж / ПНР / ТО",
    subtitle: "Надёжные системы в реальной эксплуатации",
    ...
    works: [
      ...
      "Монтаж систем противодымной вентиляции (ВПВ)",
  ...
  },
  {
    ...
    subtitle: "Экспертная оценка и практические решения",
    text: "Проводим аудит объектов, анализ проектных решений и действующих систем, разрабатываем рекомендации по устранению нарушений и повышению уровня пожарной безопасности.",
    cta: "Заказать аудит",
    image: y4,
    ...
    works: [
      ...
      "Экспертное заключение и техническое мнение",
      "Сопровождение при реконструкции и изменении функционального назначения",
      "Комплексные решения по повышению уровня безопасности",
    ],
  },
  {
    id: "systems",
    ...
    text: "Проектируем, поставляем, монтируем и обслуживаем системы пожарной безопасности любой сложности. Обеспечиваем надёжную защиту людей, имущества и непрерывность работы объектов.",
...
export default function Services() {
  ...
  const activeDirection =
    activeIndex >= 0 ? directions[activeIndex] : null;
  const nextDirection =
    activeIndex >= 0
      ? directions[(activeIndex + 1) % directions.length]
      : null;
              ...
              <div className="services__direction-works">
                ...
                <ul className="services__direction-works-grid">
                  {activeDirection.works.map((work, index) => {
                    const tones = ["white", "soft", "dash", "soft", "dash", "white", "muted", "dash", "soft", "dash", "white", "soft"];
                    ...
                    return (
                      ...
                      >
                        <span className="services__direction-work-index">
                          {activeDirection.number}.
